...
export interface GreeterInterface extends utils.Interface {
  functions: {
    ...
    "updateGreeting(string)": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "greet" | "updateGreeting"
  ): FunctionFragment;
...
export interface Greeter extends BaseContract {
  ...
  functions: {
    greet(overrides?: CallOverrides): Promise<[string] & { _greeting: string }>;
  ...
  callStatic: {
    ...
    updateGreeting(_greeting: string, overrides?: CallOverrides): Promise<void>;
  };
